...
[`guesser_core/logic/SurroundingWordWidth.py`](../../guesser_core/logic/SurroundingWordWidth.py)
...
[ProcessRedactions](process-redactions-docs.md) and the refiner architecture in
...
ranges) live in [`geometry.py`](../../guesser_core/logic/geometry.py).
