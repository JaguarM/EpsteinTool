...
I opted to build a fresh, highly performant UI using standard HTML/CSS/JS and the `pdf.js` rendering engine rather than reverse-engineering the massive, extension-specific [pdf_viewer_wrapper.js](https://github.com/JaguarM/EpsteinTool/blob/main/guesser_core/static/guesser_core/pdf-viewer.js) from the original Chrome files. 
