...
<span class="line">│   │   └── masking.py              # Shared mask generation (used by tesseract_ocr)</span>
<span class="line">│   ├── templates/                  # Base index.html (iterates registry for plugins)</span>
<span class="line">│   └── static/guesser_core/        # Base UI JS (pdf-viewer.js, app.js, state.js)</span>
<span class="line">│</span>
...
<span class="line">│</span>
<span class="line">├── tesseract_ocr/                  # Plugin App (OCR via Tesseract)</span>
<span class="line">│   ├── tool.py                     # TesseractOcrTool(PDFTool)</span>
<span class="line">│   ├── apps.py</span>
<span class="line">│   ├── views.py                    # /tesseract-ocr/run-ocr</span>
<span class="line">│   ├── urls.py</span>
<span class="line">│   └── logic/</span>
<span class="line">│       └── tesseract_runner.py     # Tesseract OCR execution</span>
<span class="line">│</span>
<span class="line">├── redaction_matching/             # Plugin App (AI Sidebar Tools)</span>
<span class="line">│   ├── tool.py                     # RedactionMatchingTool(PDFTool)</span>
<span class="line">│   ├── apps.py</span>
<span class="line">│   ├── templates/                  # sidebar_tools.html, toolbar_button.html</span>
<span class="line">│   └── static/redaction_matching/  # api.js, styles.css</span>
<span class="line">│</span>
<span class="line">├── embedded_text_viewer/           # Plugin App (Legacy Inline Text Overlay)</span>
...
<span class="line">│</span>
<span class="line">├── extracted_text/                  # Backend-only App (no PDFTool, no UI)</span>
<span class="line">│   ├── apps.py                     # AppConfig with url_prefix/url_module</span>
...
<span class="line">        APP<span class="token text string">[&quot;app.js / pdf-viewer.js&quot;]</span></span>
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
...
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
<span class="line">    <span class="token keyword">subgraph</span> <span class="token string">&quot;tesseract_ocr (Plugin)&quot;</span></span>
<span class="line">        OCR_TOOL<span class="token text string">[&quot;tool.py\\nTesseractOcrTool&quot;]</span></span>
<span class="line">        OCR_V<span class="token text string">[&quot;views.py&quot;]</span></span>
<span class="line">        TR<span class="token text string">[&quot;tesseract_runner.py&quot;]</span></span>
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
...
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
<span class="line">    <span class="token keyword">subgraph</span> <span class="token string">&quot;extracted_text (Backend-only)&quot;</span></span>
<span class="line">        ET_V<span class="token text string">[&quot;views.py&quot;]</span></span>
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
<span class="line">    <span class="token comment">%% Registration flow</span></span>
...
<span class="line">    BASE <span class="token arrow operator">-.-&gt;</span><span class="token label property">|&quot;inherits&quot;|</span> OCR_TOOL</span>
...
<span class="line">    OCR_TOOL <span class="token arrow operator">--&gt;</span><span class="token label property">|&quot;@register_tool&quot;|</span> REG</span>
...
<span class="line">    urls <span class="token arrow operator">--&gt;</span> ET_V</span>
<span class="line"></span>
...
<span class="line">    OCR_V <span class="token arrow operator">--&gt;</span> TR</span>
<span class="line">    TR <span class="token arrow operator">-.-&gt;</span><span class="token label property">|&quot;uses&quot;|</span> MASK</span>
