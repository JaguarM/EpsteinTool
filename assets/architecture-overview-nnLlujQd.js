...
<span class="line">│   │   └── refiners/               # Refiner framework (contracts only — concrete refiners live in plugins)</span>
...
<span class="line">│   │       └── registry.py         # RefinerRegistry + @register_refiner; ProcessRedactions builds its pipeline from this</span>
...
<span class="line">            RF_REG<span class="token text string">[&quot;registry.py\\nRefinerRegistry&quot;]</span></span>
<span class="line">        <span class="token keyword">end</span></span>
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
...
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
<span class="line">    <span class="token keyword">subgraph</span> <span class="token string">&quot;redaction_refiner (Plugin)&quot;</span></span>
<span class="line">        RR_TOOL<span class="token text string">[&quot;tool.py\\nRedactionRefinerTool&quot;]</span></span>
<span class="line">        RR_ETV<span class="token text string">[&quot;etv_refiner.py\\nEtvRefiner&quot;]</span></span>
<span class="line">    <span class="token keyword">end</span></span>
<span class="line"></span>
...
<span class="line">    RR_TOOL <span class="token arrow operator">--&gt;</span><span class="token label property">|&quot;@register_tool&quot;|</span> REG</span>
<span class="line"></span>
...
<span class="line">    PR <span class="token arrow operator">--&gt;</span> RF_REG</span>
<span class="line">    RF_REG <span class="token arrow operator">--&gt;</span> RF_PIPE</span>
<span class="line">    RF_PIPE <span class="token arrow operator">--&gt;</span> RF_BASE</span>
<span class="line">    RR_ETV <span class="token arrow operator">--&gt;</span><span class="token label property">|&quot;@register_refiner&quot;|</span> RF_REG</span>
<span class="line">    RR_ETV <span class="token arrow operator">--&gt;</span> SW</span>
<span class="line">    RR_ETV <span class="token arrow operator">--&gt;</span> RF_BASE</span>
